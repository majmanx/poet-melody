...
STYLES: Dict[str, Style] = {
    ...
    "folk": Style(
        ...
        time_signatures=((4, 4), (3, 4)), harmony=HarmonyOptions(diminished=False, sevenths=0.0, sus=0.3, cadence="plagal"),
    ...
    "neo_soul": Style(
        ...
        swing=0.58, harmony=HarmonyOptions(diminished=False, sevenths=1.0, extensions=0.8, mixture=0.3, cadence="plagal"),
    ...
    "lofi": Style(
        ...
        swing=0.6, harmony=HarmonyOptions(diminished=False, sevenths=0.95, extensions=0.6, mixture=0.25, cadence="plagal"),
    ...
    "pop": Style(
        ...
        harmony=HarmonyOptions(diminished=False, sevenths=0.1, cadence="none"), library_ratio=0.85,
    ...
    "synthwave": Style(
        ...
        harmony=HarmonyOptions(diminished=False, sevenths=0.05, sus=0.25, cadence="none"), library_ratio=0.85,
    ...
    "house": Style(
        ...
        swing=0.54, harmony=HarmonyOptions(diminished=False, sevenths=0.5, extensions=0.2, cadence="none"), library_ratio=0.8,
    ...
    "trance": Style(
        ...
        harmony=HarmonyOptions(diminished=False, sevenths=0.0, cadence="none"), library_ratio=0.85,
    ...
    "ambient": Style(
        ...
        bars_per_chord=2, harmony=HarmonyOptions(diminished=False, sevenths=0.9, extensions=0.5, sus=0.4, cadence="plagal"), library_ratio=0.7,
